    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="hidden md:block relative min-h-[560px]">
            <img src="/auth.jpg" alt="cover" className="absolute inset-0 h-full w-full object-cover" />
          </div>
          ...
          <div className="p-8 md:p-12">
            <DialogHeader className="mb-4">
              <div className="flex items-start justify-between">
                <DialogTitle className="text-4xl font-semibold tracking-tight">Login</DialogTitle>
              </div>
            </DialogHeader>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-muted-foreground">Account</Label>
              ...
              <div className="flex items-center justify-end -mt-2">
                <Button type="button" variant="link" className="px-0 text-muted-foreground">Forgot password</Button>
              </div>
              ...
              <div className="relative py-2">
                <Separator />
                <span className="absolute left-1/2 -translate-x-1/2 -top-3 bg-background px-3 text-xs text-muted-foreground">or login with</span>
              </div>
